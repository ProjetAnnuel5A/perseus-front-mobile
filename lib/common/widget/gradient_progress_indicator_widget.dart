// ignore_for_file: use_key_in_widget_constructors, library_private_types_in_public_api, prefer_int_literals, prefer_const_constructors_in_immutables, unused_element, lines_longer_than_80_chars
...
class GradientProgressIndicator extends StatefulWidget {
  const GradientProgressIndicator({
    ...
    this.gradientStops = const [0.2, 0.8],
    this.radius = 120,
    this.strokeWidth = 3,
    this.duration = 1,
